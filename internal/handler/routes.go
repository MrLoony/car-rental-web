...
func (h *Handler) Routes() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.With(h.RequireCSRF).Post("/admin/cars/{id}/gallery", h.AdminCarGalleryCreate())
		r.With(h.RequireCSRF).Post("/admin/cars/{id}/gallery/{imageID}/primary", h.AdminCarGallerySetPrimary())
		r.With(h.RequireCSRF).Post("/admin/cars/{id}/gallery/{imageID}/delete", h.AdminCarGalleryDelete())
